(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/forms'), require('@angular/common'), require('rxjs'), require('@angular/router'), require('@angular/platform-browser'), require('tslib')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', '@angular/forms', '@angular/common', 'rxjs', '@angular/router', '@angular/platform-browser', 'tslib'], factory) :
	(factory((global['angular-bootstrap-md'] = {}),global.ng.core,global.ng.forms,global.ng.common,global.Rx,global.ng.router,global.ng.platformBrowser,global.tslib));
}(this, (function (exports,core,forms,common,rxjs,router,platformBrowser,tslib) { 'use strict';
